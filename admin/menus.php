...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">       
        ...
        <li><a href="user_list.php"><i class="fa fa-tags"></i> Admin List</a></li>
        <li><a href="user_list_2.php"><i class="fa fa-tags"></i> Lecturer List</a></li>
        <li><a href="user_list_3.php"><i class="fa fa-tags"></i> Student List</a></li>    
        <li><a href="report.php"><i class="fa fa-tags"></i> Reports</a></li>
	</ul>
</div>
